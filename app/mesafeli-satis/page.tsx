      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <div style={{ background: "white", borderRadius: 24, padding: "40px 48px", boxShadow: "0 4px 24px rgba(92,61,46,0.07)" }}>
          {[
            ...
            { no: "4", baslik: "SATICI BİLGİLERİ", icerik: "Ünvanı: TNB PET MAMA VE AKSESUARLARI İTHALAT İHRACAT LİMİTED ŞİRKETİ\nAdres: ATİLLA MAHALLESİ NO: 32/B KONAK/İZMİR\nVergi No: 9381208717\nTelefon: +90 552 090 80 01\nE-posta: info@evemama.net" },
