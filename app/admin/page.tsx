...
import Kuponlar from "./components/Kuponlar";
    ...
    <main style={{ minHeight: "100vh", background: "#F0EBE3", fontFamily: "sans-serif", display: "flex" }}>
      ...
      <div style={{ marginLeft: 220, flex: 1, padding: "28px 28px 60px", minWidth: 0 }}>
        ...
        {aktifSayfa === "kategoriler" && (
          <Kategoriler kategoriler={kategoriler} yeniKategori={yeniKategori} setYeniKategori={setYeniKategori} kategoriEkle={kategoriEkle} kategoriAktifToggle={kategoriAktifToggle} kategoriSil={kategoriSil} setDuzenleKategori={setDuzenleKategori} slugUret={slugUret} s={s} btn={btn} />
        )}

        {aktifSayfa === "markalar" && (
          <Markalar markalar={markalar} yeniMarka={yeniMarka} setYeniMarka={setYeniMarka} markaEkle={markaEkle} markaAktifToggle={markaAktifToggle} markaSil={markaSil} setDuzenleMarka={setDuzenleMarka} slugUret={slugUret} s={s} btn={btn} />
        )}

        {aktifSayfa === "kuponlar" && (
          <Kuponlar yeniKupon={yeniKupon} setYeniKupon={setYeniKupon} kuponlar={kuponlar} kuponEkle={kuponEkle} kuponlariYukle={kuponlariYukle} goster={goster} s={s} btn={btn} />
        )}
        ...
        {/* ── BLOG SORULARI ────────────────────────────────────────────────── */}
        {aktifSayfa === "blog" && (
          <Blog bekleyenSorular={bekleyenSorular} blogSorular={blogSorular} cevaplar={cevaplar} setCevaplar={setCevaplar} blogSorulariYukle={blogSorulariYukle} istatistikleriYukle={istatistikleriYukle} goster={goster} btn={btn} />
        )}
        ...
        {aktifSayfa === "ayarlar" && (
          <SiteAyarlari siteAyarlari={siteAyarlari} setSiteAyarlari={setSiteAyarlari} siteAyarKaydet={siteAyarKaydet} s={s} btn={btn} />
        )}
